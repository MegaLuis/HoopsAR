...
//This script works with its ball. Inter alia it sends an events to any listeners about its actions like thrown, goaled, failed.
public class ARBallControl : MonoBehaviour
{
